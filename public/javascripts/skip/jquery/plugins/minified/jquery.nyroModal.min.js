...
var from=currentSettings.from;var url;if(from&&from.nodeName){currentSettings.url=url=from.nodeName.toLowerCase()=='form'?from.action:from.href;if(from.rev=='modal')
