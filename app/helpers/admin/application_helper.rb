...
<<<<<<< HEAD:app/helpers/admin/application_helper.rb
...
=======
    output << generate_tab_link( s_('Admin::SettingsController|literal'), admin_settings_path(:tab => :literal), request.url == admin_settings_url(:tab => :literal) )
    output << generate_tab_link( s_('Admin::ImagesController'), admin_images_path, request.url.include?(admin_images_url) )
    output << generate_tab_link( s_('Admin::DocumentsController'), admin_documents_path, request.url.include?(admin_documents_url) )
    ...
    output << generate_tab_link( s_('Admin::SettingsController|other'), admin_settings_path(:tab => :other), request.url == admin_settings_url(:tab => :other) )
>>>>>>> for_i18n:app/helpers/admin/application_helper.rb
    output << '</ul>'
  end
