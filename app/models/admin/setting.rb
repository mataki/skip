...
class Admin::Setting < ActiveRecord::Base
  ...
  N_('Admin::Setting|Contact url description')
  ...
  N_('Admin::Setting|Login password description')
  N_('Admin::Setting|Login account example')
  N_('Admin::Setting|Login account example description')
  N_('Admin::Setting|Header logo url')
  N_('Admin::Setting|Header logo url description')
  ...
  N_('Admin::Setting|Footer image url description')
  ...
  N_('Admin::Setting|Raise delivery errors description')
